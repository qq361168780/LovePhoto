<?php global $array;$video=lp_video_detail();?>
<div class="archive">
	...
	<div class="archive-body">
		...
		<div class="archive-content clearfix">
			<div class="archive-thumbnail">
				<a href="<?php the_permalink(); ?>" title="<?php the_title();?>">
					<img src="<?php echo $video["original"];?>" alt="<?php the_title(); ?>" width="160" height="108" />
				</a>
		...
		<div class="archive-footer clearfix">
			来至 <a href="<?php echo get_post_format_link('video')?>">视频</a><span class="archive-blank">/</span>分类 <?php the_category(' '); ?>
			<div class="right">
