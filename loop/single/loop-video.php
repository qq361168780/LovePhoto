<?php global $author_id;$author_id = get_the_author_id();$video = lp_video_detail();?>
	...
	<div class="single-player">
		<iframe height="100%" width="100%" src="http://player.youku.com/embed/<?php echo $video["youkuid"];?>" frameborder=0 allowfullscreen></iframe>
	</div>
	<div class="single-desc">
		<strong>简介：</strong>
		<?php $desc = lp_strip_tags($post->post_content);echo  $desc ?  $desc : "暂无简介";?>
	</div>
